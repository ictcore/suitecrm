<?php /* Smarty version 2.6.29, created on 2017-12-19 09:36:11
...
">
        <?php endif; ?>
            <?php if ($this->_tpl_vars['result']->target_module != null): ?>
                <img src="index.php?entryPoint=getImage&themeName=SuiteP&imageName=<?php echo $this->_tpl_vars['result']->target_module; ?>
s.gif"/>
